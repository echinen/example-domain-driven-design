...
namespace ExampleDDDArchitecture.Application
{
    public class CotacaoAppService : AppServiceBase<Cotacao>, ICotacaoAppService
    {
        ...
        public CotacaoAppService(ICotacaoService cotacaoService)
            : base(cotacaoService)
        {
        ...
        {
            var tarifa = _cotacaoService.CheckIfTariffExist(origemDDD, destinoDDD);
        ...
        {
            return _cotacaoService.FindPlan(id);
        }
    }
}
